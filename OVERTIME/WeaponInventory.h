...
public:
	...
	EngineL::WeaponPickup* tryDropWeapon(float x, float y, bool haveShotgun, bool haveSubmachinegun);

	void reloadAll();

	void increaseCapacityAll(float magazineIncrease, float reserveIncrease);
