...
bool SceneManager::updateMenus(EngineL::InputManager& input, const sf::RenderWindow& window, EngineL::Player& player)
{
    ...
    {
        SkillTreeAction action = skillTreeScreen.handleInput(input, window, player);
